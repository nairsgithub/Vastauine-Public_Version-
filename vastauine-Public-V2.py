#!/usr/bin/env/python
#updated 04/06/2016
#(update)This is VastauineIOT Project's PYTHON_SQL_PHP PYTHON END SOFTWARE.VERSION 2.0
...
print("Vastauine IOT Windows.v.0.2")
...
def main(entred_username,entred_password):
    ...
    try:
    	conn1=MySQLdb.connect(user='vastawcn_public',passwd='*777public*',host='111.118.215.65',db='vastawcn_rpi')
    except:
    ...
    #MYSQL_Making connection to rpi database
    try:
    	conn2=MySQLdb.connect(user='vastawcn_public',passwd='*777public*',host='111.118.215.65',db='vastawcn_user')
    except:
